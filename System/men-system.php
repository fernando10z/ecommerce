...
// Conectamos con el config específico de MEN
require_once __DIR__ . '/apariencia/men-config.php';
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row-actions" style="justify-content: flex-end;">
                                                ...
                                                <button type="submit" form="form_del_<?php echo $prod['id']; ?>" name="btn_del_product" class="btn-action btn-reset" title="Borrar" style="color: #dc2626;" onclick="return confirm('¿Borrar este producto?')">
