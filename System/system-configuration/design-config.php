...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (isset($_POST['btn_guardar_global'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', $viejos_datos, $nuevos_datos);
        ...
        elseif (isset($_POST['btn_save_logo'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', ['logo_name' => $datos_actuales['logo_name']], ['logo_name' => $val]);
        ...
        elseif (isset($_POST['btn_save_primary'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', ['primary_color' => $datos_actuales['primary_color']], ['primary_color' => $val]);
        ...
        elseif (isset($_POST['btn_save_secondary'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', ['secondary_color' => $datos_actuales['secondary_color']], ['secondary_color' => $val]);
        ...
        elseif (isset($_POST['btn_save_tertiary'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', ['tertiary_color' => $datos_actuales['tertiary_color']], ['tertiary_color' => $val]);
        ...
        elseif (isset($_POST['btn_save_font'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', ['font_style' => $datos_actuales['font_style']], ['font_style' => $val]);
        ...
        elseif (isset($_POST['btn_save_banner'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', 
        ...
        elseif (isset($_POST['btn_save_footer_desc'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'update', ['footer_description' => $datos_actuales['footer_description']], ['footer_description' => $val]);
        ...
        elseif (isset($_POST['btn_reiniciar'])) {
            ...
            $viejos_datos = array_intersect_key($datos_actuales, $nuevos_datos);
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', $viejos_datos, $nuevos_datos);
        ...
        elseif (isset($_POST['btn_reset_nombre'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', ['logo_name' => $datos_actuales['logo_name']], ['logo_name' => SITE_NAME]);
        ...
        elseif (isset($_POST['btn_reset_primary'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', ['primary_color' => $datos_actuales['primary_color']], ['primary_color' => PRIMARY_COLOR]);
        ...
        elseif (isset($_POST['btn_reset_secondary'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', ['secondary_color' => $datos_actuales['secondary_color']], ['secondary_color' => SECONDARY_COLOR]);
        ...
        elseif (isset($_POST['btn_reset_tertiary'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', ['tertiary_color' => $datos_actuales['tertiary_color']], ['tertiary_color' => TERTIARY_COLOR]);
        ...
        elseif (isset($_POST['btn_reset_font'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', ['font_style' => $datos_actuales['font_style']], ['font_style' => FONT_STYLE]);
        ...
        elseif (isset($_POST['btn_reset_banner'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', ['top_banner_text' => $datos_actuales['top_banner_text']], ['top_banner_text' => BANNER]);
        ...
        elseif (isset($_POST['btn_reset_footer_desc'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design', 1, 'restore', ['footer_description' => $datos_actuales['footer_description']], ['footer_description' => FOOTER_DESC]);
