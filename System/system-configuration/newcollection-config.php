...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        if (isset($_POST['btn_guardar_global'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design_new_collection', 1, 'update', $viejos_datos, $nuevos_datos);
        ...
        elseif (isset($_POST['btn_save_hero_label'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design_new_collection', 1, 'update', 
        ...
        elseif (isset($_POST['btn_del_hero_label'])) {
            ...
            registrarAuditoria($conn, $organization_id, $usuario_actual_id, 'web_design_new_collection', 1, 'delete', 
