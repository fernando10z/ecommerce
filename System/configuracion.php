...
require_once __DIR__ . '/configuracionlogico.php';
                ...
                <div class="config-card">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="form-label">Nombre del Sitio (Atelier)</label>
                            <input type="text" class="form-input" name="logo_name" value="<?php echo $datos_actuales['logo_name']; ?>" required placeholder="Ej. Mi Empresa">
                        </div>

                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                <label class="form-label">Color Primario</label>
                                <input type="color" class="form-input" name="primary_color" value="<?php echo $datos_actuales['primary_color']; ?>">
                            </div>

                            <div class="form-group">
                                <label class="form-label">Color Secundario</label>
                                <input type="color" class="form-input" name="secondary_color" value="<?php echo $datos_actuales['secondary_color']; ?>">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Color de Acento</label>
                            <input type="color" class="form-input" name="accent_color" value="<?php echo $datos_actuales['accent_color']; ?>">
                        </div>
                        
                        <div class="form-group">
                        <label class="form-label">Imagen de fondo (Hero)</label>
                        <input type="file" class="form-input" name="hero_image" accept="image/*">
                        ...
                        <?php if (!empty($datos_actuales['image_background'])): ?>
                            ...
                            <img
                                src="<?= htmlspecialchars($datos_actuales['image_background']); ?>"
                                style="margin-top:8px;max-width:100%;border-radius:10px;border:1px solid #ddd"
                            >
                        <?php endif; ?>
                         </div>

                        <button type="submit" name="btn_guardar" class="btn-primary">
